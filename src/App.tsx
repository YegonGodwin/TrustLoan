          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl mb-8 text-blue-100">
                Get instant access to personal and business loans with
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Making financial growth accessible to everyone
              </p>
            </div>
            <div>
...
function ApplyPage() {
  ...
  const [formData, setFormData] = useState<LoanFormData>({
    ...
    mpesaNumber: "",
    nationalId: "",
    loanType: "personal", // Consistent casing
  });
  const [isSubmitting, setIsSubmitting] = useState(false); // Fix: Use let and setter
  const [submitted, setSubmitted] = useState(false); // Fix: Use let and setter
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Match backend expected fields (fullName -> name, etc.)
      const payload = {
        fullName: formData.name, // Map 'name' to 'fullName' for backend
      ...
      setFormData({
        ...
        mpesaNumber: "",
        nationalId: "",
        loanType: "personal", // Consistent reset value
      });
    } catch (error) {
      console.error("Error submitting loan application:", error);
      setError(
        "Failed to submit application. Please try again or check your connection."
      );
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-600">
          Rate: <span className="font-semibold text-gray-900">{rate}</span>
        </p>
      </div>
      <button
        onClick={onApply}
